...
|`instance_ip_list`|Optional `instance_id` and `instance_ip` fields are not required if this field is provided|List|Enter a list of public or private IP addresses separated by comma that you want to start, stop, or reboot. E.g 10.240.64.4,10.240.64.5|
